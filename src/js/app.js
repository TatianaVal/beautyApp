...
function mostrarSeccion() {
    ...
    // Quital la clase de actual al tab anterior
...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function(e) {
        ...
        if( [6, 0].includes(dia) ) {
            e.target.value = '';
            mostrarAlerta('Los fines de semana no son permitidos', 'error', '.formulario');
        } else {
...
function mostrarResumen() {
    ...
    //Limpiar el cotenido de resumen
    ...
    // Heading para los servicios del resumen
    ...
    servicios.forEach(servicio => {
        ...
        // Heading para los Cita del resumen
